...
שיפורים:
את איתחול הלוח להעביר לבורד. 
אם לא אז להכניס את הפונקציה "אינסרט" לפונקציית האיתחול כי הלוגיקה שלהם דומה.
אם משאירים, לעשות את מערך התאים החיים גלובלי ולהשתמש בבורד ע"י "אינטרנל". כך אין מעבר פוינטרים בין קבצים.
את התאים החיים ההתחלתיים כדאי למקם כשכנים ולא רנדומלי. 
אולי גם לתת למשתמש לקבוע את מספר התאים החיים ולא רנדומלי
לשנות את הלוגיקה של מעבר על כל השכנים שקוראת לפונקציה שקוראת לכל השכנים, זה קצת כפילות לוגיקה
במקום עדיף לעשות רקורסיה שעוברת על כל השכנים
בהדפסה להשתמש בספריה (קורסס) שיוצרת הדפסה יפה יותר ובמקום ולא הדפסה חוזרת לקונסול.
להדפיס את התאים ולא חלל.
